...
const UpdateProfile = () => {
    ...
    return (
        <div className="container mx-auto min-h-[calc(100vh-400px)]">
            <Helmet>
            ...
            <div className="flex items-center justify-center p-10">
                <div className="flex items-center justify-center text-center">
                    <form onSubmit={handleUpdateProfile} className="flex flex-col w-full max-w-lg p-12 rounded shadow-lg dark:text-gray-800">
                        ...
                        <button className="flex items-center justify-center h-12 px-6 mt-8 text-sm font-semibold rounded dark:bg-violet-600 dark:text-gray-50">Update</button>
                    </form>
                </div>
            </div>
