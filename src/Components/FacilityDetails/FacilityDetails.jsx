...
const FacilityDetails = () => {
    ...
    return (
        <div>
                        ...
                        <div className='flex gap-4'>
                            {
                                facilities.map((service, idx) => (
                                    <div key={idx} className="">
                                        <div className="lg:w-40 lg:h-44 border-2 p-6 space-y-3 text-center hover:bg-[#FFE6E6] hover:border-[#474F7A] hover:cursor-pointer hover:scale-90 duration-500">
            ...
            {/* Area section */}
            <section className='mt-10 h-[440px] flex items- justify-center' style={areaSection}>
                <div className='flex flex-col items-center lg:gap-5 p-4'>
                    <div>
                        <h1 className='text-5xl font-marcellus font-bold'>
                            Area
                        </h1>
                    </div>
            ...
            {/* Location section */}
            <section className='h-[440px] flex items- justify-center' style={locationSection}>
                <div className='flex flex-col items-center lg:gap-5 p-4'>
                    <div>
                        <h1 className='text-5xl font-marcellus font-bold'>
                            Location
            ...
            {/* Price section */}
            <section className='h-[440px] flex items- justify-center' style={areaSection}>
                <div className='flex flex-col items-center lg:gap-5 p-4'>
                    <div>
                        <h1 className='text-5xl font-marcellus font-bold'>
                            Price
