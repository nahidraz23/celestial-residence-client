...
const UserProfile = () => {
    ...
    return (
        <div className="container mx-auto min-h-[calc(100vh-599px)] flex justify-center my-20">
            <Helmet>
                <title>CR | User Profile</title>
            </Helmet>
            <div className="flex flex-col gap-5">
                <div>
                    <h1 className="text-5xl text-center font-marcellus font-semibold">User Details</h1>
                </div>
